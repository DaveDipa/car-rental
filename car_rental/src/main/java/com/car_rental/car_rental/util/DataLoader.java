...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(LocalDate.of(2023, 12, 26), LocalDate.of(2023,12,30),c1, 100.0);
        Order o2 = new Order(LocalDate.of(2023, 01, 30), LocalDate.of(2023, 01, 31),c2, 35.0);
        Order o3 = new Order(LocalDate.of(2023, 02, 13), LocalDate.of(2023, 02, 25),c3, 360.0);
        Order o4 = new Order(LocalDate.of(2023, 03, 28), LocalDate.of(2023, 03, 30),c4, 20.0);
